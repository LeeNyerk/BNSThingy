...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Name="form">
	    ...
	    <Label Name="PingLabel" Content="Ping: 32 ms" Margin="716,68.893,0,0" Padding="1" VerticalAlignment="Top" HorizontalAlignment="Left" Width="147" Foreground="White" Opacity="0.8" FontFamily="Segoe UI Semibold"/>
        </Grid>
