...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        <ResourceDictionary xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml">
            ...
            <ControlTemplate x:Key="ComboBoxToggleButton" TargetType="{x:Type ToggleButton}">
                <Grid>
                    ...
                    <Border x:Name="Border" Grid.ColumnSpan="2" CornerRadius="1" BorderThickness="1" BorderBrush="#FF4C86BB" Background="{StaticResource ButtonBackground}" Margin="152,0,0,0"/>
                    <Border x:Name="BorderPressed" Grid.ColumnSpan="2" CornerRadius="1" BorderThickness="1" BorderBrush="#FF315685" Opacity="0" Background="{StaticResource ButtonBackgroundPress}" Margin="152,0,0,0"/>
                    <Border x:Name="BorderOver" Grid.ColumnSpan="2" CornerRadius="1" BorderThickness="1" BorderBrush="#FF294970" Opacity="0" Background="{StaticResource ButtonBackgroundOver}" Margin="152,0,0,0"/>
            ...
            <!-- Style for Profile Folder Button -->
            <Style x:Key="ProfileButton" TargetType="{x:Type Button}" BasedOn="{StaticResource CloseButton}">
                <Setter Property="Template">
                    <Setter.Value>
                        <ControlTemplate>
                            <Grid>
                                <Border Background="Transparent"/>
                                <Path Stretch="Uniform" Fill="#FFFFFFFF" Data="M13.07 10.41A5 5 0 0 0 13.07 4.59A3.39 3.39 0 0 1 15 4A3.5 3.5 0 0 1 15 11A3.39 3.39 0 0 1 13.07 10.41M5.5 7.5A3.5 3.5 0 1 1 9 11A3.5 3.5 0 0 1 5.5 7.5M7.5 7.5A1.5 1.5 0 1 0 9 6A1.5 1.5 0 0 0 7.5 7.5M16 17V19H2V17S2 13 9 13 16 17 16 17M14 17C13.86 16.22 12.67 15 9 15S4.07 16.31 4 17M15.95 13A5.32 5.32 0 0 1 18 17V19H22V17S22 13.37 15.94 13Z" VerticalAlignment="Bottom" HorizontalAlignment="Center"/>
                            </Grid>
                            <ControlTemplate.Triggers>
                                <Trigger Property="IsMouseOver" Value="True">
                                    <Trigger.EnterActions>
    ...
    <Grid Name="form">
        ...
        <Grid Name="TopBar" Margin="0,0,0,517" Height="68">
            ...
            <TextBox Name="SourceInput" HorizontalAlignment="Left" Height="28" Margin="20,20,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="227" Opacity="0.7" BorderBrush="#FF363A3B" Background="#FF141E29" Padding="25,5,5,5" FontFamily="Segoe UI Semibold" FontSize="11" Foreground="#FFFFFFFF" SelectionBrush="#FF474747" />
            ...
            <Button Name="SelectSourceButton" HorizontalAlignment="Left" VerticalAlignment="Top" Margin="252,20,0,0" Height="28" Width="28" Style="{StaticResource SimpleButtonStyle}">
            ...
            <ComboBox Name ="LanguageSelection" Margin="300,20,0,0" Height="28" Width="180" VerticalAlignment="Top" HorizontalAlignment="Left">
                <ComboBoxItem Content="ENGLISH"/>
                <ComboBoxItem Content="FRENCH"/>
                <ComboBoxItem Content="GERMAN"/>
                <ComboBoxItem Content="BPORTUGUESE"/>
            </ComboBox>
            <Label Name="LanguageLabel" HorizontalAlignment="Left" Opacity="0.8" VerticalAlignment="Top" Margin="302,22,0,0" Foreground="White">
            ...
            <Button Name="BnsFButton" HorizontalAlignment="Center" Content="BNS" VerticalAlignment="Top" Margin="869,19.999,156,0" Height="15" Width="15" Style="{StaticResource BnSButton}" Foreground="#CCFFFFFF" >
                <ToolTipService.ToolTip >
                    <ToolTip Style="{StaticResource CustomTooltip}" Content="BNS Folder"/>
                </ToolTipService.ToolTip>
            </Button>
            <Button Name="ModFButton" Content="Mods" HorizontalAlignment="Center" VerticalAlignment="Top" Margin="887,19.999,138,0" Height="15" Width="15" Style="{StaticResource ModButton}">
                <ToolTipService.ToolTip >
                    <ToolTip Style="{StaticResource CustomTooltip}" Content="Mods Folder"/>
                </ToolTipService.ToolTip>
            </Button>
            <Button Name="PluginFButton" HorizontalAlignment="Center" Content="Plugins" VerticalAlignment="Top" Margin="907,19.999,118,0" Height="15" Width="15" Style="{StaticResource PatchButton}" RenderTransformOrigin="0.8,1.267">
                <ToolTipService.ToolTip >
                    <ToolTip Style="{StaticResource CustomTooltip}" Content="XML Patches Folder"/>
                </ToolTipService.ToolTip>
            </Button>
            <Button Name="AddonFButton" HorizontalAlignment="Center" Content="Addons" VerticalAlignment="Top" Margin="928,19.999,97,0" Height="15" Width="15" Style="{StaticResource AddonButton}">
                <ToolTipService.ToolTip >
        ...
        <Grid Name="BotBar" Margin="0,480,0,0" Height="105">
            <Border CornerRadius="0" Background="#FF141E29" BorderThickness="0" BorderBrush="#FF363A3B" Opacity="0.8"/>
            <TextBox Name="UsernameInput" HorizontalAlignment="Left" VerticalAlignment="Top" Height="28" Margin="20,20,0,0" Padding="25,5,5,5" FontFamily="Segoe UI Semibold" FontSize="11" Foreground="#FFFFFFFF" TextWrapping="Wrap" Width="260" Opacity="0.7" BorderBrush="#FF363A3B" Background="#FF141E29" SelectionBrush="#FF474747">
                <ToolTipService.ToolTip >
            ...
            <ComboBox Name ="ProfileSelector" Margin="300,20,0,0" Height="28" Width="180" VerticalAlignment="Top" HorizontalAlignment="Left" FontFamily="Segoe UI Semibold" FontSize="11">
                <ToolTipService.ToolTip >
                    <ToolTip Style="{StaticResource CustomTooltip}" Content="Select user profile"/>
                </ToolTipService.ToolTip>
            </ComboBox>
            <Label Name="ProfileSelectorLabel" HorizontalAlignment="Left" Opacity="0.8" VerticalAlignment="Top" Margin="300,22,0,0" Foreground="White">
            ...
            <TextBox Name="NewProfileInput" HorizontalAlignment="Left" VerticalAlignment="Bottom" Height="28" Margin="300,0,0,20" Padding="25,5,5,5" FontFamily="Segoe UI Semibold" FontSize="11" Foreground="#FFFFFFFF"  TextWrapping="Wrap" Width="147" Opacity="0.7" BorderBrush="#FF363A3B" Background="#FF141E29" SelectionBrush="#FF474747">
                <ToolTipService.ToolTip >
                    <ToolTip Style="{StaticResource CustomTooltip}" Content="Enter name for a new user profile"/>
                </ToolTipService.ToolTip>
            </TextBox>
            <Label Name="NewProfileLabel" HorizontalAlignment="Left" VerticalAlignment="Bottom" Margin="300,0,0,22" Foreground="White" Opacity="0.8">
            ...
            <Button Name="SaveButton" HorizontalAlignment="Left" VerticalAlignment="Bottom" Margin="452,0,0,20" Height="28" Style="{StaticResource SimpleButtonStyle}" Width="28">
            ...
            <CheckBox Name="LaunchOpt1" Content="Unattended" Margin="564,18,0,0" VerticalAlignment="Top" HorizontalAlignment="Left" Height="16" Width="130"/>
            <CheckBox Name="LaunchOpt2" Content="No Texture Streaming" Margin="564,44,0,0" VerticalAlignment="Top" HorizontalAlignment="Left" Height="16" Width="130"/>
            <CheckBox Name="LaunchOpt3" Content="Use all Cores" Margin="564,71,0,0" VerticalAlignment="Top" HorizontalAlignment="Left" Width="130" Height="16"/>
            <RadioButton Name="RegionSelection1" GroupName="Regions" Style="{StaticResource SquareRadioButton}" Content="EU" Margin="718,18.685,290,70.315" Height="16" Width="32"/>
	    ...
	    <Label Name="PingLabel" FontSize="11" Margin="716,68.893,0,0" Padding="1" VerticalAlignment="Top" HorizontalAlignment="Left" Width="147" Foreground="White" Opacity="0.8" FontFamily="Segoe UI Semibold"/>
        </Grid>
        <Grid Name="GroupBox1" Margin="20,158.5,0,236.5" Width="320" Height="190" HorizontalAlignment="Left" VerticalAlignment="Center">
            ...
            <CheckBox Name="CheckFX12" Content="SUM 3RD" Margin="85,87,0,0" VerticalAlignment="Top" HorizontalAlignment="Left" Width="75" Height="16"/>
        ...
        <Grid Name="GroupBox2" Margin="361,158.5,359,236.5" Width="320" Height="190" VerticalAlignment="Center">
            ...
            <CheckBox Name="CheckAN12" Content="SUM 3RD" Margin="85,87,0,0" VerticalAlignment="Top" HorizontalAlignment="Left" Height="16" Width="71"/>
        ...
        <Grid Name="GroupBox3" Margin="0,158.5,20,236.5" Width="320" Height="190" HorizontalAlignment="Right" VerticalAlignment="Center">
            ...
            <CheckBox Name="CheckEX3" Content="Soul, Heart Effects" Margin="10,71,0,0" VerticalAlignment="Top" HorizontalAlignment="Left" Height="16"/>
            <CheckBox Name="CheckEX4" Content="Mystic Badge Effects" Margin="10,87,0,0" VerticalAlignment="Top" HorizontalAlignment="Left" Height="16"/>
...
# Summoner 3rd Skill Effects
$sum3FXFiles = "00080169.upk"
# Blade Dancer Skill Effects
$bdFXFiles = "00031769.upk", "00060555.upk"
# Blade Dancer 3rd Skill Effects
...
# Soul + Heart Effects
$soulheartFXFiles = "00061518.upk", "00009805.upk"
# Mystic Badge Effects
$mysticFXFiles = "00080278.upk"
# UI Effects
...
foreach ($elementchk in $sum3FXFiles) {
	if ($inBackup -contains $elementchk) { $CheckFX12.IsChecked = $false }
	elseif ($isMissing -contains $elementchk) { $CheckFX12.IsChecked = $false }
	else { $CheckFX12.IsChecked = $true }
}
...
foreach ($elementchk in $bd3FXFiles) {
	if ($inBackup -contains $elementchk) { $CheckFX14.IsChecked = $false }
	elseif ($isMissing -contains $elementchk) { $CheckFX14.IsChecked = $false }
	else { $CheckFX14.IsChecked = $true }
}
...
foreach ($elementchk in $sum3ANFiles) {
	if ($inBackup -contains $elementchk) { $CheckAN12.IsChecked = $false }
	elseif ($isMissing -contains $elementchk) { $CheckAN12.IsChecked = $false }
	else { $CheckAN12.IsChecked = $true }
}
...
foreach ($elementchk in $bd3ANFiles) {
	if ($inBackup -contains $elementchk) { $CheckAN14.IsChecked = $false }
	elseif ($isMissing -contains $elementchk) { $CheckAN14.IsChecked = $false }
	else { $CheckAN14.IsChecked = $true }
}
...
foreach ($elementchk in $soulheartFXFiles) {
...
foreach ($elementchk in $mysticFXFiles) {
...
function Filemover {
	...
	elseif ($this -eq $CheckFX12) { $item = $sum3FXFiles }
	...
	elseif ($this -eq $CheckAN12) { $item = $sum3ANFiles }
	...
	elseif ($this -eq $CheckEX3) { $item = $soulheartFXFiles }
	elseif ($this -eq $CheckEX4) { $item = $mysticFXFiles }
...
function getPing {
	...
	$PingLabel.Content = "Ping: $($ping.responsetime) ms"
}

$timer = New-Object System.Windows.Forms.Timer
$timer.Interval = 5000
$timer.add_tick({getPing})

#$PingLabel.IsChecked = $true
$timer.start()
...
#$PingLabel.Add_Checked({startTimer $this $_})
#$PingLabel.Add_Unchecked({stopTimer $this $_})
...
$ProfileFButton.Add_Click({OpenProfiles $this $_})
...
$CheckFX12.Add_Checked({Filemover $this $_})
$CheckFX12.Add_Unchecked({Filemover $this $_})
$CheckFX13.Add_Checked({Filemover $this $_})
$CheckFX13.Add_Unchecked({Filemover $this $_})
$CheckFX14.Add_Checked({Filemover $this $_})
...
$CheckAN12.Add_Checked({Filemover $this $_})
$CheckAN12.Add_Unchecked({Filemover $this $_})
$CheckAN13.Add_Checked({Filemover $this $_})
$CheckAN13.Add_Unchecked({Filemover $this $_})
$CheckAN14.Add_Checked({Filemover $this $_})
